...
class SchemaGenerator {
    ...
    generateSchema() {
      ...
      const removeEmptyStrings = this.config.outputOptions?.json?.removeEmptyStrings || false;
      ...
      elementProperties[propNames.value] = {
        description: "Text content of the element or raw content for mixed content elements",
        type: "string",
      };
      ...
      const attrProperties = elementProperties[propNames.attributes].patternProperties["^.*$"].properties;
      ...
      elementProperties[propNames.attributes].patternProperties["^.*$"].required = requiredAttrProps;
